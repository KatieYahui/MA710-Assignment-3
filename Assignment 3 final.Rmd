...
source(file="C:/Users/student/Desktop/MA710/Tuesday version/Assignment 3/20170321_TextMining_functions.R")
```
...
save(article.df, 
     file="C:/Users/student/Desktop/MA710/Tuesday version/Assignment 3/article.df.RData") 
```
...
```{r}
load(file="C:/Users/student/Desktop/MA710/Tuesday version/Assignment 3/article.df.RData")
```
...
We could use common word by frequency to visualize each cluster.
...
We could build word cloud based on the frequency:
We use `brewer.pal` function to create a valid color schemes for th words.
